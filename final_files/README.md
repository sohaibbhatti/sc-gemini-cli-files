...
This folder contains the final state of all files after completing the actions demonstrated throughout the course.
...
- **teckstack-conference** - All conference documents and subdirectories
    ...
    - **`data-analysis/`** - Lead scan data and analysis files from the conference

### Bonus Lesson

- **`learning/`** - Course materials and study resources for the learning lesson (Lesson 10)
